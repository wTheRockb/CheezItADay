...
def generate_audio(index):
    tts_string = f"Day {index} of posting a picture of every cheez it in this box. Also Annalisa is a massive weaboo"
    tts = gTTS(tts_string)
    tts.save('tts.mp3')
    return "tts.mp3"
...
def main():
    ...
    image_clip = ImageClip(cropped_image, duration=15)
